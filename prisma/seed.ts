...
async function seedDatabase() {
    try {
        ...
        // Nomes criativos para as Unidades de Negócio
        const creativeNames = [
            "Barbearia Vintage",
            "Corte & Estilo",
            "Barba & Navalha",
            ...
            "Renew Beauty Clinic",
            "Estilo Urbano",
            "Serenity Spa & Esthetics",
        ];

        //Emails fictícios para as Unidades de Negócio
        const creativeEmails = [
            "barbeariavintage@email.com",
            "corte_estilo@email.com",
            "barbaenavalha@email.com",
            "incantorisalon@email.com",
            "cabeloecia@email.com",
            "esteticabellavita@email.com",
            "barbeariaelegance@email.com",
            "renewbeautyclinic@email.com",
            "estilourbano@email.com",
        ...
        const services = [
            ...
            },
            {
                ...
                price: 25.0,
                imageUrl: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fbr.freepik.com%2Ffotos%2Ftratamento-cabelo&psig=AOvVaw0GI_h8vW_oq7hwzx_0ZSA0&ust=1707356177441000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCNjBu5KLmIQDFQAAAAAdAAAAABAE",
            },
        ];
